...
declare class Entity {
    constructor(client: Client, type: entityType, id: number, { x, y, z, yaw, pitch }: {
        x: number;
        y: number;
        z: number;
        yaw: number;
...
type windowType = 'horse' | 'anvil' | 'beacon' | 'brewing_stand' | 'chest' | 'container' | 'crafting_table' | 'dispenser' | 'dropper' | 'enchanting_table' | 'furnace' | 'hopper' | 'villager';