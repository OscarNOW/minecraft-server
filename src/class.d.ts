...
export class Window {
    ...
    constructor(windowType: 'horse', horse: Entity);
...
type windowType = 'anvil' | 'beacon' | 'brewing_stand' | 'chest' | 'container' | 'crafting_table' | 'dispenser' | 'dropper' | 'enchanting_table' | 'furnace' | 'hopper' | 'villager';